...
const Navbar = () => {
  ...
  const handleLogOut = () => {
   logout()
    ...
    const navLinks = <>
        <li  className="mr-3 border-zinc-700 border-2 bg-green-300  rounded-md"><NavLink to="/requests">Donation Requests</NavLink></li>
        <li  className="mr-3 border-zinc-700 border-2 bg-green-300 rounded-md"><NavLink to="/blog">Blog</NavLink></li>
        
        { user && <>
           <li  className="mr-3 border-zinc-700 border-2 bg-green-300 rounded-md"><NavLink to="/fundings">Fundings</NavLink></li>
