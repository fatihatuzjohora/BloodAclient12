...
const RequestDetail = () => {
  ...
  const handleAdd = (e) => {
    ...
    fetch(`https://blood-theta.vercel.app/donate/${_id}`, {
      method: "PUT",
      headers: {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 items-center w-[85%] mx-auto my-10 py-10 md:pl-5 bg-[#e9e9e9f3]">
      <div className="space-y-4 flex flex-col gap-4 justify-start">
        ...
        <p className="pb-2  text-xl font-medium border-[#13131326]">
          Dictrict :{dictrict}
        </p>
        <p className="pb-3  text-xl font-medium border-[#13131326]">
          Upazila :{upazila}
        </p>
        <p className="pb-2  text-xl font-medium border-[#13131326]">
          Hospital :{hospital}
      ...
      <div className="flex flex-col gap-4">
        <h2 className="text-4xl font-bold primary-font">
          Recipient :{recipient}
        </h2>
        ...
        <p className="my-4">
          <span className=" font-bold">Description :</span> {massage}
        </p>
        <div className="w-Full flex flex-col gap-2 pb-6 border-b-2  border-[#13131326]"></div>
        <div className="flex flex-row justify-between">
          ...
          <dialog id="my_modal_3" className="modal">
            <div className="modal-box">
              ...
              <h1 className="text-center text-xl font-semibold text-orange-700 ">
                Donate
              </h1>
